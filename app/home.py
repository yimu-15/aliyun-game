...
def render(results, team_map, team_ratings, groups, n_sim):
    ...
    <div class="hero-section">
        <div class="hero-title">🏆 世界杯冠军预测 Agent</div>
        <div class="hero-subtitle">
            真实数据驱动 &nbsp;|&nbsp; 可解释预测 &nbsp;|&nbsp; 可视化赛程树 &nbsp;|&nbsp; 端到端自动化<br>
            五维度评分 + 泊松模型 + 蒙特卡洛模拟 &nbsp;|&nbsp; Streamlit + FastAPI + Docker
        </div>
    </div>
    ...
    if results:
        ...
        with col_champ:
            ...
            <div class="champion-card">
                ...
                <div class="team">{top_name}</div>
                <div class="prob">夺冠概率 <b>{top.champion_prob:.1%}</b></div>
                <div class="ci">95% CI: [{top.ci_low:.1%}, {top.ci_high:.1%}]</div>
            </div>
            """, unsafe_allow_html=True)
    ...
    # ── 8. 推理过程解释面板 ──
    st.markdown('<div class="section-title">🧠 推理过程说明</div>', unsafe_allow_html=True)
